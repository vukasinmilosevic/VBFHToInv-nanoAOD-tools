...
p=PostProcessor('.',inputFiles(), modules=[TriggerSelectionConstructor(),LooseMuonConstructorData(),LooseElectronConstructorData(),JetCleaningConstructorXCl(),CRLooseMuonConstructorData(),CRTightMuonConstructorData(),CRLooseElectronConstructorData(),CRTightElectronConstructorData(),VLooseTauConstructorData(),LoosePhotonConstructor(),MediumBJetConstructorData(),MetCleaningConstructor_baseLooseLeptons(),DiCleanJetVariableConstructor(),CRDiMuonCreatorConstructor(),CRDiElectronCreatorConstructor(),CRSingleMuonCreatorConstructor(),CRSingleElectronCreatorConstructor(),SelectionCreatorConstructorTemp()],provenance=True,fwkJobReport=True,jsonInput='Cert_294927-306462_13TeV_EOY2017ReReco_Collisions17_JSON_v1.txt')
