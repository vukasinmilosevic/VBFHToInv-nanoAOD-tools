...
class CRCreator(Module):
    def __init__(self, metCollectionName = "MET", LooseLep1CollectionName = "Muon", TightLep1CollectionName = "Muon", LooseLep2CollectionName = None, TightLep2CollectionName = None):
    ...
    def beginFile(self, inputFile, outputFile, inputTree, wrappedOutputTree):
        ...
        if self.LooseLep2CollectionName and self.TightLep2CollectionName:
...
CRCreatorConstructor = lambda : CRCreator(metCollectionName = "MetNoLooseMuon", LooseLep1CollectionName = "CRLooseMuon", TightLep1CollectionName = "CRTightMuon", LooseLep2CollectionName = None, TightLep2CollectionName = None)
