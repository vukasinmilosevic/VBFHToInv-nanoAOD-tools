...
CRLooseMuonConstructor = lambda : ObjectCleaning(collectionName= "Muon", outCollectionName = "CRLooseMuon", selection = 'abs(obj.eta) < 2.4 and obj.pt > 10 and obj.pfRelIso04_all < 0.25 and not(obj.pfRelIso04_all < 0.15)',SFnamePrefix = 'Muon', SFname = 'effSF_Loose',SFval = None)
CRTightMuonConstructor = lambda : ObjectCleaning(collectionName= "Muon", outCollectionName = "CRTightMuon", selection = 'abs(obj.eta) < 2.4 and obj.pt > 10 and obj.pfRelIso04_all < 0.25 and obj.pfRelIso04_all < 0.15',SFnamePrefix = 'Muon', SFname = 'effSF_Tight',SFval = None)
